...
import { ChevronRight, SlidersHorizontal, Search as SearchIcon } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-6">
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <span className="text-foreground">{t("resultsFor")}: "{query}"</span>
        </div>

        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold">
              {query ? `${t("resultsFor")} "${query}"` : t("allProductsLabel")}
            </h1>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 bg-card rounded-lg">
            ...
            <h2 className="text-lg font-medium mb-2">{t("noResultsFound")}</h2>
            <p className="text-muted-foreground mb-4">{t("tryDifferent")}</p>
